...
- [onedr0p/flux-cluster-template @ v5.4.0](https://github.com/onedr0p/flux-cluster-template/releases/tag/v5.4.0) (3 weeks ago)
...
- **[onedr0p/flux-cluster-template](https://github.com/onedr0p/flux-cluster-template)** - A community opinionated template for deploying a single Kubernetes cluster with Ansible backed by Flux, SOPS, GitHub Actions, Renovate, Cilium and more! (4 days ago)
