...
- [onedr0p/flux-cluster-template @ 2024.1.0](https://github.com/onedr0p/flux-cluster-template/releases/tag/2024.1.0) (3 weeks ago)
...
- **[onedr0p/flux-cluster-template](https://github.com/onedr0p/flux-cluster-template)** - A community opinionated template for deploying a Kubernetes cluster backed by Flux, SOPS, GitHub Actions, Renovate, Cilium and more! (6 months ago)
